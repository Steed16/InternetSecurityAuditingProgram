...
namespace ComputerNetworks
{
    ...
    {
        public static string[] FactArray = new string[1000];
        public static void MakeTheRandomFactList()
        {
            FactArray = Regex.Split(@"Butterflies cannot fly if their body temperature is less than 86 degrees.
